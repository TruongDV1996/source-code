...
// MFC_project.cpp : Defines the class behaviors for the application.
//
...
CPaintApp::CPaintApp()
{
	...
	SetAppID(_T("MFC_project.AppID.NoVersion"));
...
BOOL CPaintApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CPaintAppDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CPaintAppView));
	if (!pDocTemplate)
		return FALSE;
...
// CPaintApp customization load/save methods
